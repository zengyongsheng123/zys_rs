!function(e, t) {
    ...
    do
        ...
        case "M5":
            ...
            le = !Q[59]),
            ke = !Q[83]),
            (("complete" === document.readyState || "interactive" === document.readyState ? le = !Q[83] : "function" == typeof document.addEventListener && (ke = !Q[59],
            document.addEventListener("DOMContentLoaded", Ab[40]),
            document.addEventListener("readystatechange", Ab[75])),
            ke && (le = !Q[83])),
            je = !Q[59])),
            ie = !Q[59]),
            ((window && window.addEventListener && window.addEventListener("beforeunload", Ab[54]),
            ...
            jd = [Q[36], Q[61], Q[7], Q[23], Q[48], Q[68], Q[33], Q[13], Q[85], Q[16], Q[43], Q[24], Q[4] & Date.now(), Math.floor(Q[70] * Math.random()), Math.floor(Q[70] * Math.random()), Math.floor(Q[70] * Math.random())]),
            id = Q[83]),
            hd = {
                rand: Ab[69],
                seed: Ab[67]
            ...
            gc = "https://lf16-cdn-tos.tiktokcdn-us.com/obj/static-tx/slardar/fe/sdk-web/plugins/"),
            fc = "mon16-normal-useast5.tiktokv.us"),
            dc = "https://sf16-website-login.neutral.ttwstatic.com/obj/tiktok_web_login_static/slardar/fe/sdk-web/plugins"),
            cc = "mon.tiktokv.com"),
            bc = "mon-va.byteoversea.com"),
            ac = "mon-va.capcutapi.com"),
            $b = "mon-va.lemon8-app.com"),
            Zb = "mon-ttp.lemon8-app.us"),
            Yb = {
                sg: {
                    boe: hc,
                    prod: {
        ...
        case "ye":
            ...
            Ye = function(e, t, r) {
                ...
                n = new Error(t || ec[e]);
                if (n.code = e,
                Error.captureStackTrace && Error.captureStackTrace(n, Ye),
                !r)
                    throw n;
                return n
            }
            ...
            Xe = function(e, t, r, n) {
                ...
                return d != r.length && i ? Ze(r, da[3], d) : r.subarray(da[3], d)
            }
            ),
            et = new u8(Q[83])),
        ...
        case "12":
            ...
            Te = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {};
            for (var Kb = {}, Lb = "0123456789abcdef".split(""), Mb = [], Nb = [], i = 0; i < 256; i++)
            ...
            Kb.decode = function(e) {
                for (var t = e.length >> 1, r = t << 1, n = new Uint8Array(t), o = 0, a = 0; a < r; )
            ...
            (function(qf) {
                (function() {
                    ...
                    Hf = "object" == typeof window),
                    Gf = Hf ? window : {}),
                    (Gf.JS_MD5_NO_WINDOW && (Hf = !pa[5]),
                    Ff = !Hf && "object" == typeof self)),
                    Ef = !Gf.JS_MD5_NO_NODE_JS && "object" == typeof process && process.versions && process.versions.node),
                    (Ef ? Gf = Te : Ff && (Gf = self),
                    Df = !Gf.JS_MD5_NO_COMMON_JS && qf.exports)),
                    Cf = !Gf.JS_MD5_NO_ARRAY_BUFFER && "undefined" != typeof ArrayBuffer),
                    Bf = "0123456789abcdef".split("")),
                    Af = [pa[1], pa[3], pa[0], -pa[7]]),
                    zf = [pa[8], pa[4], pa[6], pa[2]]),
                    yf = ["hex", "array", "digest", "buffer", "arrayBuffer", "base64"]),
                    xf = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".split("")),
                    wf = [];
                    if (Cf) {
                    ...
                    (((((!Gf.JS_MD5_NO_NODE_JS && Array.isArray || (Array.isArray = function(e) {
                        return "[object Array]" === Object.prototype.toString.call(e)
                    }
                    ),
                    !Cf || !Gf.JS_MD5_NO_ARRAY_BUFFER_IS_VIEW && ArrayBuffer.isView || (ArrayBuffer.isView = function(e) {
                    ...
                    sf = function(Kf) {
                        var Lf, Mf, Nf;
                        return ((Nf = eval("require('crypto')"),
                        Mf = eval("require('buffer').Buffer")),
                        Lf = function(e) {
                            var ra;
                            ra = [null];
                            if ("string" == typeof e)
                                return Nf.createHash("md5").update(e, "utf8").digest("hex");
                            if (ra[0] == e)
                                throw If;
                            return e.constructor === ArrayBuffer && (e = new Uint8Array(e)),
                            Array.isArray(e) || ArrayBuffer.isView(e) || e.constructor === Mf ? Nf.createHash("md5").update(new Mf(e)).digest("hex") : Kf(e)
                        }
                        ),
                        Lf
                    }
                    ...
                    ((Db[0].prototype.update = function(e) {
                        if (!this.finalized) {
                            ...
                            if ("string" !== r) {
                                ...
                                if (null === e)
                                    throw If;
                                if (Cf && e.constructor === ArrayBuffer)
                                    e = new Uint8Array(e);
                                else if (!(Array.isArray(e) || Cf && ArrayBuffer.isView(e)))
                                    throw If;
                                t = !0
                            }
                            for (var n, o, a = 0, i = e.length, s = this.blocks, u = this.buffer8; a < i; ) {
                                ...
                                t) {
                                    ...
                                    for (o = this.start; a < i && o < 64; ++a)
                                        (n = e.charCodeAt(a)) < 128 ? u[o++] = n : n < 2048 ? (u[o++] = 192 | n >> 6,
                                        u[o++] = 128 | 63 & n) : n < 55296 || n >= 57344 ? (u[o++] = 224 | n >> 12,
                                        u[o++] = 128 | n >> 6 & 63,
                                        u[o++] = 128 | 63 & n) : (n = 65536 + ((1023 & n) << 10 | 1023 & e.charCodeAt(++a)),
                                        u[o++] = 240 | n >> 18,
                                        u[o++] = 128 | n >> 12 & 63,
                                        u[o++] = 128 | n >> 6 & 63,
                                        u[o++] = 128 | 63 & n);
                                    ...
                                    for (o = this.start; a < i && o < 64; ++a)
                                        (n = e.charCodeAt(a)) < 128 ? s[o >> 2] |= n << zf[3 & o++] : n < 2048 ? (s[o >> 2] |= (192 | n >> 6) << zf[3 & o++],
                                        s[o >> 2] |= (128 | 63 & n) << zf[3 & o++]) : n < 55296 || n >= 57344 ? (s[o >> 2] |= (224 | n >> 12) << zf[3 & o++],
                                        s[o >> 2] |= (128 | n >> 6 & 63) << zf[3 & o++],
                                        s[o >> 2] |= (128 | 63 & n) << zf[3 & o++]) : (n = 65536 + ((1023 & n) << 10 | 1023 & e.charCodeAt(++a)),
                    ...
                    Db[0].prototype.hash = function() {
                        ...
                        i = this.blocks),
                        (this.first ? t = ((t = ((e = ((e = i[ta[59]] - ta[15]) << ta[97] | e >>> ta[51]) - ta[55] << ta[59]) ^ (r = ((r = (-ta[55] ^ (n = ((n = (-ta[35] ^ ta[54] & e) + i[ta[4]] - ta[11]) << ta[75] | n >>> ta[44]) + e << ta[59]) & (-ta[55] ^ e)) + i[ta[34]] - ta[92]) << ta[27] | r >>> ta[84]) + n << ta[59]) & (n ^ e)) + i[ta[24]] - ta[19]) << ta[49] | t >>> ta[66]) + r << ta[59] : (e = this.h0,
                        t = this.h1,
                        r = this.h2,
                        ...
                        this.first ? (this.h0 = e + ta[52] << ta[59],
                        this.h1 = t - ta[55] << ta[59],
                        this.h2 = r - ta[35] << ta[59],
                        this.h3 = n + ta[72] << ta[59],
                        this.first = !ta[4]) : (this.h0 = this.h0 + e << ta[59],
                    ...
                    Db[0].prototype.base64 = function() {
                        ...
                        return e = o[a],
                        n += xf[e >>> xa[1]] + xf[e << xa[0] & xa[2]] + "=="
                    }
                    ),
                    rf = tf())),
                    Df ? qf.exports = rf : Gf.md5 = rf
                }
                )()
            }(Se),
            Re = Se.exports)),
        ...
        case "Ut":
            ...
            , function() {
                ...
                if (e && "function" == typeof e && !(Pe() || navigator.userAgent.toLowerCase().indexOf("vivobrowser") > lb[0])) {
                    var t = [];
                    return new Promise(function(r) {
                        try {
                            ...
                            n.onicegatheringstatechange = function() {
                                var mb;
                                mb = [null],
                                "complete" === n.iceGatheringState && (n.close(),
                                n = mb[0])
                            }
                            ,
                            ...
                            }).then(o).catch(o) : n.createOffer(function(e) {
            ...
            , function(e) {
                ...
                if ("number" == typeof e)
                    return [];
                if ("function" != typeof e && ("object" !== pf(e) || Va[0] === e))
                    throw new TypeError("Object.keys called on non-object");
                n = [];
                for (var o in e)
                    Sd.call(e, o) && n.push(o);
                if (t)
                    for (var a = 0; a < r.length; a++)
                        Sd.call(e, r[a]) && n.push(r[a]);
                return n
            }
            , function() {
            ...
            , function(e) {
                ...
                return (Wa = [0, 0, 1],
                t = e || ""),
                t = (t = -Wa[2] !== (t = t.replace(Wa[0], "")).indexOf("?") ? t.substr(Wa[1], t.indexOf("?")) : t) || "/"
            }
            , function() {
                document.dispatchEvent(new Event(qe))
            }
            , function(e, t) {
                var r;
                r = e.slice(),
            ...
            , function(e) {
                try {
                    ...
                    return "[object Boolean]" === t ? !0 === e ? 1 : 2 : "[object Function]" === t ? 3 : "[object Undefined]" === t ? 4 : "[object Number]" === t ? 5 : "[object String]" === t ? "" === e ? 7 : 8 : "[object Array]" === t ? 0 === e.length ? 9 : 10 : "[object Object]" === t ? 11 : "[object HTMLAllCollection]" === t ? 12 : "object" === pf(e) ? 99 : -1
                } catch (e) {
                    return -2
                }
            }
            ...
            , function(e, t, r, n, o, a) {
                ...
                s = !Ja[0]),
                u = !Ja[0]),
                ("function" == typeof t && document.addEventListener(qe, function() {
                    var Ka;
                    Ka = [0],
                    setTimeout(function() {
                        var r, La;
                ...
                "function" == typeof r && document.addEventListener(pe, function() {
                    var Ma;
                    Ma = [0],
                    setTimeout(function() {
                        var t, Na;
                ...
                "function" == typeof n && document.addEventListener(oe, function() {
                    var Oa;
                    Oa = [0],
                    setTimeout(function() {
                        var t, Pa;
                ...
                "function" == typeof o && document.addEventListener(me, function() {
                    var t, Qa;
                    Qa = [0],
                    t = o(s);
                    if (t.error)
                ...
                "function" == typeof a && window.addEventListener(ne, function() {
                    var t;
                    t = a();
                    if (t.error)
                        Bb[0]("error", {
            ...
            , function(e) {
                return Array.isArray(e) ? e.map(Ab[20]) : e instanceof Object ? Ab[23](e).sort().reduce(function(t, r) {
            ...
            , function(e, t) {
                if ("string" == typeof t)
                    for (var r, n = e + "=", o = t.split(/[;&]/), a = 0; a < o.length; a++) {
            ...
            , function(e) {
                ...
                (xb = [1, 100, 2, 0],
                t = !xb[3]),
                xb[3] === e ? window._xex && window._xex.r && window._xex.r(e, Ve, t) : xb[0] === e ? setTimeout(function() {
                    var yb;
                    yb = [1, null],
                    kc(Ie, Ge.slardarErrs, Ve, !yb[0], yb[1], t)
                }, xb[1]) : xb[2] === e && window._xex && window._xex.r && window._xex.r(e, Ve, t)
            }
            , function(e, t) {
                if (e) {
                    if ("string" == typeof e)
                    ...
                    "Map" === r || "Set" === r ? Array.from(e) : "Arguments" === r || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r) ? Ab[55](e, t) : void 0
                }
            }
            , function(e) {
                var $a;
            ...
            , function(e, n, o, a) {
                ...
                y = []),
                h = []),
                ("object" != typeof globalThis && (Object.defineProperty(Object.prototype, "__1479382789__", {
                    get: function() {
                        return this
                    },
                    configurable: !ga[1]
                        ...
                        if (e < 38) {
                            ...
                            if (e < 47) {
                                if (e < 42) {
                                    if (e < 40) {
                                        ...
                                        var U = i[d++];
                                        m -= U;
                                        var M = y.slice(m + 1, m + U + 1)
                                          , F = y[m--]
                                          , j = y[m--];
                                        if ("function" != typeof F)
                                            return c = 3,
                                            void (p = new TypeError(typeof F + " is not a function"));
                                        var B = l.get(F);
                                        if (B)
                                            h.push([i, s, u, g, f, d, c, p]),
                                            Cb[0](B[0], j, M, B[1]);
                                        else {
                                            var N = F.apply(j, M);
                                            y[++m] = N
                            ...
                            if (e < 69) {
                                if (67 === e) {
                                    ...
                                    if (!(Z in globalThis))
                                        return c = 3,
                                        void (p = new ReferenceError(Z + " is not defined"));
                                    o = globalThis[Z],
                                    y[++m] = o
                                } else
                                    o = y[m--],
            ...
            , function(e, t, r) {
                return Ab[34]([].concat(kd, Ab[53](e)), t, r)
            }
            , function(e) {
                var t;
                t = [];
            ...
            , function() {
                ...
                document.removeEventListener("DOMContentLoaded", Ab[40]),
                document.removeEventListener("readystatechange", Ab[75])) : le || je || (le = !Fa[0])
            }
            , function(e, t) {
                for (var r = 0; r < t.length; r++)
            ...
            , function(e, t) {
                try {
                    ...
                    document.cookie = e + "=" + t + "; expires=" + new Date(new Date().getTime() + 7776e6).toGMTString() + "; path=/;")
                } catch (e) {}
            }
            , function(e, t) {
                var r, Sa;
            ...
            , function(e) {
                try {
                    var t = "";
                    return window.sessionStorage && (t = window.sessionStorage.getItem(e)) || window.localStorage && (t = window.localStorage.getItem(e)) ? t : t = Ab[25](e, document.cookie)
                } catch (e) {
                    return ""
                }
            }
            , function(e, t) {
                var oa;
                return oa = [256, 0, 10],
                (e.charCodeAt(oa[1]) ^ (this + this % oa[2] * t) % oa[0]) >>> oa[1]
            }
            , function(e) {
                if (!e || "{}" === Td(e))
                    return "";
            ...
            , function(e, t) {
                ...
                if (e) {
                    ...
                    if (r) {
                        var n = pf(r);
                        return "object" === n || "function" === n ? 1 : "string" === n ? n.length > 0 ? 1 : 2 : Ab[0](r) ? 1 : 2
                    }
                }
                return Ta[0]
            }
            ...
            , function(e, t, r, n, o) {
                ...
                !function e() {
                    if (!(l >= g.length)) {
                        ...
                        ,
                        l < g.length && (r.addEventListener("error", e),
            ...
            , function(e, t, r) {
                for (var n = Ab[71](e, t), o = 0; o < Vb.length; o++)
                    Vb[o].setOptions(r),
                    Vb[o].subscribe(n)
            }
            , function() {
                var Ea;
                return Ea = [1],
                -Ea[0] !== ["complete", "interactive"].indexOf(document.readyState)
            }
            , function(e) {
            ...
            , function() {
                ...
                for (var s = ["Trebuchet MS", "Wingdings", "Sylfaen", "Segoe UI", "Constantia", "SimSun-ExtB", "MT Extra", "Gulim", "Leelawadee", "Tunga", "Meiryo", "Vrinda", "CordiaUPC", "Aparajita", "IrisUPC", "Palatino", "Colonna MT", "Playbill", "Jokerman", "Parchment", "MS Outlook", "Tw Cen MT", "OPTIMA", "Futura", "AVENIR", "Arial Hebrew", "Savoye LET", "Castellar", "MYRIAD PRO"], u = 0, l = 0; l < s.length; l++)
                    for (var g = 0; g < t.length; g++) {
                        ...
                        var p = d.offsetWidth !== r[f] || d.offsetHeight !== n[f];
                        if (document.body.removeChild(d),
                        p) {
                            l < 30 && (u |= 1 << l);
                            break
                        }
            ...
            , function(e) {
                var za;
                za = [null];
                if ("undefined" != typeof Symbol && za[0] != e[Symbol.iterator] || za[0] != e["@@iterator"])
                    return Array.from(e)
            }
            , function(e, t) {
                return {
            ...
            , function(e, t) {
                var eb;
                return eb = [0, null, 1],
                eb[1] == e || eb[0] === e.length ? e : (e = Ab[83](e),
                t = Ab[83](t),
            ...
            , function(e, t) {
                ...
                for (var a = 0; a < r; a++)
                    e[a] = String.fromCharCode(255 & e[a], e[a] >>> 8 & 255, e[a] >>> 16 & 255, e[a] >>> 24 & 255);
                return i = e.join(""),
                t ? i.substring(Ya[1], n) : i
            }
            , function(e, t, n, i) {
                return r.length || function(e) {
                    var i, t, ea;
                    (ea = [0],
                    t = function(e) {
                        var fa;
                    ...
                    for (o = 0; o < i; ++o) {
                        for (var g = Ab[76](t), d = Boolean(Ab[76](t)), c = new Array, p = Ab[76](t), m = 0; m < p; ++m)
                            c.push([Ab[76](t), Ab[76](t), Ab[76](t), Ab[76](t)]);
                        ...
                        if (!(a < 55296 || a > 57343)) {
                            if (n + 1 < r) {
                                ...
                                if (a < 56320 && 56320 <= i && i <= 57343) {
                                    ...
                                    t[o] = String.fromCharCode(240 | s >> 18 & 63, 128 | s >> 12 & 63, 128 | s >> 6 & 63, 128 | 63 & s),
                                    ++n;
                                    continue
                                }
                            }
            ...
            , function(e, t) {
                ...
                if (!r) {
                    if (Array.isArray(e) || (r = Ab[29](e)) || t && e && "number" == typeof e.length) {
                        r && (e = r);
                        var n = 0
                          , o = function() {};
                        return {
            ...
            , function(e, t) {
                var r, ya;
                ya = [null],
                r = ya[0] == e ? ya[0] : "undefined" != typeof Symbol && e[Symbol.iterator] || e["@@iterator"];
                if (ya[0] != r) {
            ...
            (fl[Q[28]] = Q[66],
            ef[Q[66]] = Q[28]);
            for (var _b = ff(hf, 0), fd = _b.b, mf = new lf(32768), Ib = 0; Ib < 32768; ++Ib) {
            ...
            for (var nf = function(e, t, r) {
                var s, i;
                for (var n = e.length, o = 0, a = new lf(t); o < n; ++o)
                    e[o] && ++a[e[o] - 1];
                s = new lf(t);
                for (o = 1; o < t; ++o)
                    s[o] = s[o - 1] + a[o - 1] << 1;

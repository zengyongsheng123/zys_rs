function VM167() {
 ...
 v0 = functionVM168;               //BYTECODE_POS: 1 
 ...
 executionStack[3] = v0;           //BYTECODE_POS: 14 // depth = 1
 v0 = undefined                    //BYTECODE_POS: 17 
 v1 = executionStack[0];           //BYTECODE_POS: 18 depth
 v2 = executionStack[3];           //BYTECODE_POS: 21 depth
 v3 = undefined                    //BYTECODE_POS: 24 
 v4 = executionStack[2];           //BYTECODE_POS: 25 depth
 v5 = undefined                    //BYTECODE_POS: 28 
 v6 = undefined                    //BYTECODE_POS: 29 
 v7 = undefined                    //BYTECODE_POS: 30 
 v0 = v1(v2,v3,v4,v5,v6,v7);       //BYTECODE_POS: 31 // context 0 could be custom vm or native func
 executionStack[4] = v0;           //BYTECODE_POS: 33 // depth = 1

function VM171() {
 ...
 v0 = functionVM172;               //BYTECODE_POS: 1 
 executionStack[5] = v0;           //BYTECODE_POS: 3 // depth = 1
 ...
 v1 = executionStack[2];           //BYTECODE_POS: 18 depth
 v2 = executionStack[3];           //BYTECODE_POS: 21 depth
 v3 = executionStack[5];           //BYTECODE_POS: 24 depth

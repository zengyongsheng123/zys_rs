...
document = {
    getElementById: function (arg) {
        // console.log('getElementById的参数:', arg)
    },
    body: {},
        ...
        if (arg == 'div') {
            return {
                getAttribute: function (arg) {
                    // console.log('div的getAttribute的参数:', arg)
                },
                addEventListener: function (arg1) {
                    // console.log('div的addEventListener的参数:', arg1)
                }
            }
        }
    }
...
location = {
    "ancestorOrigins": {},
    "href": "https://dun.163.com/trial/jigsaw?force=true",
...
function get_data (gj, token, zb) {
  ...
  console.log(f0)
    data = {
        ...
        'ext': window._ff(window._f8(token, 2+ ',' + traceData['length']))
    }

...
params = {
    ...
    "e": "P7MLKWGQRZ3SLXXEEPA36HPKZWLWB6YYPWRFOGCBBQFFMSZL56O7DVCK5TYPTIXH36HS26GIFXYNWJZM5T5EG5BVOI",
    "j": "jdd03MUSK5LTRNAAUFD3HGO33DMWB757NKHIWQCV2RRT6BEOT4ZX3MCLTHNATBXT4RINO22AEHSYD777H7ZEFV72ZGEALSIAAAAMW4H77Z3QAAAAADWL5LUSE7DAFTEX",
    "lang": "zh_CN",
    "callback": callback
}
...
distance = int(int(box[0])*342/360)
print(distance)
...
# node=execjs.get()
# js=node.compile(open('kkk.js','r', encoding="utf-8").read())
# func_name=f'JDJRValidate["prototype"].getCoordinate({distance})'
# data_track = js.eval(func_name)
# print(data_track)
# data_track = generate_human_track(distance)
data_track = offer(distance)
print(data_track)
dd = getCoordinate(data_track)

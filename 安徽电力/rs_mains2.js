...
//     console.log("---------->window的attachEvent======>", args)
// };
...
document={
    ...
    getElementById: function (arg) {
        console.log("---------->document的getElementById======>", arg);
        if (arg === "a") {
            return watch({style: watch({visibility: 'hidden'}, "document.getElementById===>[a].style"),
                setAttribute: function (arg, arg1) {
                    console.log("---------->a标签的setAttribute方法接受的参数====>",arg,arg1)
                },
                addBehavior:"",
    ...
    getElementsByTagName: function (arg) {
        ...
        if (arg === "base") {
            return watch([], "document.getElementsByTagName===>[base]")
        }
        if (arg === "script") {
            return watch([{

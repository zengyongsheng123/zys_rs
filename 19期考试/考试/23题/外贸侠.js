...
const wasmCode = fs.readFileSync('main.wasm');
  WebAssembly.instantiate(wasmCode, t.importObject).then(result => {
      var instance = result.instance;
      t.run(instance);
	  const event = { id: 1, this: undefined, args: ["124346545","56878e654a3f25fa8a62dc2eb56dca4a", "6f3b1a55494a26ac3e2b635552178f59","", "",""]};
				t._pendingEvent = event;
				t._resume();
				// return event.result;
	  console.log(event.result)
      // console.log(t._makeFuncWrapper(1)("15545454545","f95f5b6ce3bdb1a1300b5fdf37bd5ed9","a17ef5a37238ebf353e9064639efe903","","",""))
  })

...
class SliderCaptchaSolver:
    ...
    def get_slide_distance(self, slide_path, bg_path):
        """使用 OCR 计算滑块距离"""
        try:
            ...
            result = ocr.slide_match(slide, bg, simple_target=False)
            slide_distance = int(result['target'][0] * 300 / 544)
    ...
    def solve_captcha(self, js_file="main.js", slide_path="slide.png", bg_path="background.png",
        ...
        try:
            ...
            slide_distance = self.get_slide_distance(slide_path, restored_bg_path)

...
def handle_route(route):
    ...
    # 拦截网页bdms文件用本地js文件替换，走本地js文件请求，然后继续原始请求让浏览器给我们补全环境信息，补全之后从网页里提取msToken以及a_bogus等参数
    ...
    with sync_playwright() as p:
        ...
        while has_more:
            ...
            query_params = [
                ...
                ("msToken",
                 "JOgeR-5LIPM_8kx9QbRkMpTMHrKBQZxd-IJiywr_SZqMG_QE3UZu4gMLfmCXZDZxzqiekQJE8fyiY2Tdbzb5M0dtaYNaAuOC_U_XhaJbtZgGGfYI1MXXAw==")
            ]
            # msToken自己从网页里拿一个就行
            ...
            data = {
                ...
                "category_id": 11222,  # 11222为发现页目录id
            ...
            try:
                response = requests.post(index_url, data=str_data, verify=False,
                                         headers={

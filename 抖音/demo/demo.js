...
const proxy_array = [
    "window", "body", "document", "history", "getContext", "localStorage", "location", "navigator", "sessionStorage", "XMLHttpRequest",
...
window._sdkGlueVersionMap = function () {};
...
document.createElement = function (res) {
    console.log("document里面createElement调用了" + res)
     if (res === "span") {
        return {}
    }
...
document.documentElement = function (res) {
    console.log("document里面documentElement-调用了" + res)
}
document.createEvent = function (res) {
    console.log("document里面createEvent调用了" + res)
...
function a_bogus(url) {
        ar = [0,1,14,url,"","Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/128.0.0.0 Safari/537.36"]

        var r = window.__u._v;
        ar[3] = url
        return (window.__u._u(r[0], ar, r[1], r[2], this))
    }
console.log(a_bogus("device_platform=webapp&aid=6383&channel=channel_pc_web&aweme_id=7379592047885323560&cursor=0&count=20&item_type=0&insert_ids=&whale_cut_token=&cut_version=1&rcFT=&update_version_code=170400&pc_client_type=1&version_code=170400&version_name=17.4.0&cookie_enabled=true&screen_width=1920&screen_height=1080&browser_language=zh-CN&browser_platform=Win32&browser_name=Chrome&browser_version=128.0.0.0&browser_online=true&engine_name=Blink&engine_version=128.0.0.0&os_name=Windows&os_version=10&cpu_core_num=20&device_memory=8&platform=PC&downlink=10&effective_type=4g&round_trip_time=50&webid=7400757919312889355&msToken=R1qstkRGkhHEJMMW2HMce4KaFa3FCIpkbNzqmt_mTecmkZazxRqSp5GkQWRC_0BEs2eii4IFrtw_LmyjWi63wU9MM5-1qJoWFh0riJm8dULAbmKkqerdtQ3ATK4KFw%3D%3D&verifyFp=verify_lzlb3eon_MtoEI8r3_uwpj_4YcZ_8HJd_FG45Gy1P3ZxW&fp=verify_lzlb3eon_MtoEI8r3_uwpj_4YcZ_8HJd_FG45Gy1P3ZxW"))